# https://github.com/sshahryiar/Raspberry-Pi-PICO---RP2040/blob/main/DVK511%20-%20PCF8563%20RTCC/PCF8563.py
...
class PCF8563:
    def __init__(self, _i2c, addr=None):
        self.alarm_on = const(0x00)
        self.alarm_off = const(0x01)
        self.i2c = _i2c
        self.i2c_address = addr if addr else PCF8563_I2C_address  # RJS Add address
    ...
    # year is 0 to 99
    #   if bit7 of month is 1, year is 19xx
    #   if bit7 of month is 0, year is 20xx (default)
    ...
    def get_alarm(self):
        ...
        alarm_state = (temp | (alarm_hour & 0x80)) >> 0x07  # noqa: F841
        alarm_hour &= 0x3F
